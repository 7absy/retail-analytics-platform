...
RAW_PATH    = f"abfss://raw@{account_name}.dfs.core.windows.net/events/footfall/{DATE_STR}/footfall.json"
BRONZE_PATH = f"abfss://curated@{account_name}.dfs.core.windows.net/bronze/footfall"
...
print(f"bronze_footfall row count: {count}")
