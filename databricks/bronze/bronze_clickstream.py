...
# MAGIC %md # Bronze — clickstream (JSON)
...
RAW_PATH    = f"abfss://raw@{account_name}.dfs.core.windows.net/events/clickstream/{DATE_STR}/clickstream.json"
BRONZE_PATH = f"abfss://curated@{account_name}.dfs.core.windows.net/bronze/clickstream"
...
print(f"bronze_clickstream row count: {count}")
